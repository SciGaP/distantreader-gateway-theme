      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav navbar-right searching-sra-links">
            ...
            <li @if(strpos($_SERVER['REQUEST_URI'], "pages/hackathon") !== false) class="active" @endif><a class="scroll" href="{{ URL::to('http://carrels.distantreader.org/hackathon.html') }}/">Hack-a-thon</a></li>
